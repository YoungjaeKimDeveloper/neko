  ...
  return (
    ...
    <div className="px-10 mb-10">
      ...
      <div className="w-full h-[100%] lg:h-[700px] rounded-card bg-red-50 flex flex-col items-center lg:justify-center py-4 lg:flex-row lg:gap-10 shadow-xl">
        ...
        />
        {/* Small Text */}
        <div className="mt-5 lg:w-[33%] lg:flex lg:flex-col lg:items-center lg:text-center lg:shadow-xl lg:h-[66%] lg:py-4 lg:rounded-card">
          ...
          {/* Big text  */}
          <div className="flex flex-col mt-8 gap-2 font-content text-xl ">
