...
const neon_comment_repo_1 = __importDefault(
  require("../../data/neon.comment.repo")
);
const error_log_1 = require("../../../../../shared/error/error.log");
const neon_post_repo_1 = __importDefault(
  require("../../../post/data/neon.post.repo")
);
...
const neon_notification_repo_1 = __importDefault(
  require("../../../notification/data/neon.notification.repo")
);
// Neon - data layer
...
const createComment = async (req, res) => {
  try {
    ...
    try {
      ...
      (0, error_log_1.errorLog)({
        location: "createComment - neon create Comment",
        error,
      });
      return (0, response_helper_1.sendResponse)({
        res: res,
    ...
    (0, error_log_1.errorLog)({
      location: "createComment - controller",
      error,
    });
    return (0, response_helper_1.sendResponse)({
      res: res,
